  ...
  return (
    <div className="issue4">
      ...
      <p>
        ...
        콘텐츠가 있을 때만 버튼이 표시되도록 했습니다. 이 접근 방식은 hover
      ...
      <p>
        setTimeout 함수를 사용하여 hover 이벤트를 1초 지연시켜 문제를 해결하고자
        했습니다. 이렇게 하면 사용자가 hover 이벤트가 활성화되기 전에 텍스트를
        입력할 수 있도록 했습니다. 안타깝게도 이 접근 방식도 마우스가 hover되는
        즉시 hover 이벤트가 발생하여 문제를 해결할 수 있는 방법이 되지
        못했습니다.
      </p>
      ...
      <p>
        ...
        브레인스토밍 기능이 트리거되지 않는다는 것이었습니다. 즉, hover event는
      ...
      <p>
        최종적으로 브레인스토밍 버튼에 원하는 hover event를 구현하는 동시에
        텍스트 입력을 방해하지 않고 클릭 시 OpenAI 브레인스토밍이 트리거되도록
        하는 데 성공했습니다.
      </p>
    </div>
  );
