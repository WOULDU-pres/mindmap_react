...
function Issue2() {
  return (
    <div className="issue2">
      <h2>Issue 2: Connecting to GPT and Using Axios</h2>
      <p>
        이 프로젝트에서 제가 직면한 또 다른 중요한 과제는 콘텐츠를 생성하기 위해
        GPT API를 통합하고, HTTP 요청을 처리하기 위해 Axios를 사용하는
        것이었습니다. GPT API와 통신할 수 있는 안정적이고 효율적인 방법이
        필요했습니다.
      </p>
      ...
      <p>
        ...
        방법을 이해하기 위해 공식 문서를 공부하는 데 시간을 할애했습니다.
      </p>
      ...
      <p>
        ...
        함수를 통해 Axios와 GPT API를 원활하게 통합할 수 있었습니다.
      </p>

      <p>
        Axios를 통한 GPT연결 경험을 통해 많은 것을 얻을 수 있었ㅅ브니다. API
        통합, 보안 통신의 중요성, Netlify Functions와 같은 서버리스 기능을
        프론트엔드 애플리케이션과 함께 사용할 때의 이점에 대해 배웠습니다. 이
        지식은 향후 프로젝트에 매우 유용할 것이고 현재 프로젝트의 기능을 크게
        향상시켰습니다.
      </p>
    </div>
  );
